...
API_HASH = os.environ.get("API_HASH", "59afaea9fa0d7e3afb99ea0dd8abf9d8")
...
DB_URI = os.environ.get("DB_URI", "mongodb+srv://sonuchaintoli1:Sonu@6367@cluster0.pz9cc.mongodb.net/?appName=Cluster0") # Warning - Give Db uri in deploy server environment variable, don't give in repo.
